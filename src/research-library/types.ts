...
export type ResearchLibraryCapacity =
  | 'papers'
  | 'source-versions'
  | 'observations'
  | 'external-ids'
...
export type RegisterResearchPaperResult =
  ...
  | { readonly status: 'capacity'; readonly resource: ResearchLibraryCapacity }
...
export type UpdateResearchAliasResult =
  | { readonly status: 'updated' | 'unchanged'; readonly paper: ResearchPaperRecord }
  | { readonly status: 'paper-not-found'; readonly paperId: ResearchPaperId }
  | {
  ...
  | { readonly status: 'capacity'; readonly resource: 'external-ids' | 'source-aliases' }
