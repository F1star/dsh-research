...
export type ResearchObservationConditions = {
    readonly status: 'reported';
    readonly values: readonly ResearchObservationCondition[];
} | {
    readonly status: 'not-applicable';
}
...
export type ResearchObservationUncertainty = {
    readonly status: 'reported';
    readonly value: ResearchReportedUncertainty;
} | {
    readonly status: 'not-applicable';
}
...
export type ResearchComparisonDirection = 'higher-is-better' | 'lower-is-better' | 'non-directional';
/**
...
export type ResearchClaimReferenceFailure = {
    ...
    readonly status: 'source-evidence-paper-mismatch';
    readonly paperIds: readonly ResearchPaperId[];
} | {
    readonly status: 'supersedes-claim-not-found';
    readonly claimId: ResearchClaimId;
} | {
    readonly status: 'supersedes-claim-inactive';
    readonly claimId: ResearchClaimId;
} | {
    readonly status: 'supersedes-claim-kind-mismatch';
    readonly claimId: ResearchClaimId;
};
...
export type ResearchSynthesisReferenceFailure = {
    readonly status: 'claim-not-found';
    readonly claimId: ResearchClaimId;
} | {
    readonly status: 'claim-inactive';
    readonly claimId: ResearchClaimId;
} | {
    readonly status: 'source-summary-uncited';
    ...
    readonly status: 'supersedes-synthesis-inactive';
    readonly synthesisId: ResearchSynthesisId;
};
...
export type WriteResearchSynthesisResult = {
    ...
    readonly question: ResearchQuestionRecord;
    readonly synthesisId: ResearchSynthesisId;
} | ResearchQuestionMutationFailure | ResearchSynthesisReferenceFailure;
/** Reading-note reference failure that leaves the aggregate unchanged. */
export type ResearchReadingNoteReferenceFailure = {
    readonly status: 'evidence-not-found';
    readonly evidenceId: ResearchEvidenceId;
} | {
    readonly status: 'passage-question-selection-required';
    readonly evidenceId: ResearchEvidenceId;
} | {
...
export type WriteResearchReadingNoteResult = {
    ...
    readonly question: ResearchQuestionRecord;
    readonly readingNoteId: ResearchReadingNoteId;
} | ResearchQuestionMutationFailure | ResearchReadingNoteReferenceFailure;
...
export type ResearchEntityReferenceFailure = {
    ...
    readonly status: 'entity-claim-kind-mismatch';
    readonly claimId: ResearchClaimId;
} | {
    readonly status: 'entity-claim-uncited';
    readonly claimId: ResearchClaimId;
} | {
    ...
    readonly status: 'supersedes-entity-not-found';
    readonly entityId: ResearchEntityId;
} | {
    readonly status: 'supersedes-entity-inactive';
    readonly entityId: ResearchEntityId;
} | {
    readonly status: 'supersedes-entity-kind-mismatch';
    readonly entityId: ResearchEntityId;
};
...
export type WriteResearchEntityResult = {
    ...
    readonly question: ResearchQuestionRecord;
    readonly entityId: ResearchEntityId;
} | ResearchQuestionMutationFailure | ResearchEntityReferenceFailure;
/** Claim purpose reported by an observation-reference failure. */
export type ResearchObservationClaimRole = 'result' | 'method' | 'dataset' | 'metric' | 'dataset-split' | 'evaluation-protocol' | 'condition';
...
export type ResearchObservationReferenceFailure = {
    ...
    readonly status: 'supersedes-observation-not-found';
    readonly observationId: ResearchObservationId;
} | {
    readonly status: 'supersedes-observation-inactive';
    readonly observationId: ResearchObservationId;
} | {
...
export type ResearchComparisonProtocolReferenceFailure = {
    ...
    readonly status: 'observation-inactive';
    readonly observationId: ResearchObservationId;
} | {
    readonly status: 'observation-stale';
    readonly observationId: ResearchObservationId;
} | {
...
export type WriteResearchComparisonProtocolResult = {
    ...
    readonly question: ResearchQuestionRecord;
    readonly comparisonProtocolId: ResearchComparisonProtocolId;
} | ResearchQuestionMutationFailure | ResearchComparisonProtocolReferenceFailure;
