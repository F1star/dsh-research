...
import type { ResearchAuthorship, ResearchQuestionId, ResearchEvidenceId, ResearchClaimId, ResearchClaimReviewId, ResearchObservationId, ResearchObservationReviewId, ResearchComparisonProtocolId, ResearchSynthesisId } from '../research-information/types.ts';
...
export type ResearchTaskMutationResult = {
    ...
    readonly view: ResearchTaskView;
} | {
    ...
    readonly status: 'stale-question';
    readonly currentRevision: number;
} | {
