...
import type { ResearchAuthorId, ResearchQuestionId, ResearchEvidenceId, ResearchClaim, ResearchClaimReview, ResearchClaimEvidenceLink, ReviewResearchClaimRequest, ReviewResearchClaimResult, ResearchFacet, ResearchReadingNote, WriteResearchReadingNoteRequest, WriteResearchReadingNoteResult, ResearchObservation, ResearchObservationState, ResearchObservationReview, ResearchEntity, ReviewResearchObservationRequest, ReviewResearchObservationResult } from '../research-information/types.ts';
import type { ResearchPaperId, ResearchSourceVersionId } from '../research-library/types.ts';
import type { ResearchTaskRecord, ResearchTaskView, ResearchTaskCheckpoint, ResearchTaskMutationResult, CreateResearchTaskRequest, UpdateResearchTaskRequest } from '../research-task/types.ts';
...
export type SaveResearchReadingPositionResult = {
    ...
    readonly position: ResearchReadingPosition;
} | {
    readonly status: 'conflict';
    readonly position: ResearchReadingPosition | null;
};
...
export type ResearchWorkspaceReviewResult = {
    ...
    readonly revision: number;
} | Exclude<ReviewResearchClaimResult, {
    readonly status: 'created';
}>;
...
export interface ResearchWorkspaceNotes {
    ...
    readonly notes: readonly {
        readonly note: ResearchReadingNote;
        readonly active: boolean;
    }[];
    readonly nextOffset: number | null;
}
...
export type ResearchWorkspaceNoteResult = {
    readonly status: 'created';
    readonly revision: number;
} | Exclude<WriteResearchReadingNoteResult, {
    readonly status: 'created';
}>;
...
export type ResearchWorkspaceObservationReviewRequest = Omit<Extract<ReviewResearchObservationRequest, {
    readonly decision: 'accepted' | 'rejected';
}>, 'author'> | Omit<Extract<ReviewResearchObservationRequest, {
    readonly decision: 'revised';
}>, 'author'>;
...
export type ResearchWorkspaceObservationReviewResult = {
    readonly status: 'created';
    readonly revision: number;
} | Exclude<ReviewResearchObservationResult, {
    readonly status: 'created';
}>;
...
export type ResearchWorkspaceObservationChoice = {
    ...
    readonly entity: ResearchEntity;
};
...
export type ResearchWorkspaceTaskCheckpoint = Pick<ResearchTaskCheckpoint, 'taskRevision' | 'stage' | 'summary' | 'comparisonOutcome' | 'createdBy' | 'createdAt'> & {
...
export type ResearchWorkspaceTaskUpdateRequest = Omit<Extract<UpdateResearchTaskRequest, {
    readonly action: 'pause' | 'block' | 'resume';
}>, 'author'> | Omit<Extract<UpdateResearchTaskRequest, {
...
export type ResearchWorkspaceTaskMutationResult = {
    readonly status: 'saved';
    readonly taskId: ResearchTaskRecord['id'];
    readonly revision: number;
} | {
    readonly status: 'cannot-advance';
    readonly issues: readonly string[];
} | Exclude<ResearchTaskMutationResult, {
    readonly status: 'saved' | 'cannot-advance';
}>;
...
export type ResearchWorkspaceTaskRuns = {
    ...
    readonly runs: readonly ResearchTaskRunView[];
    readonly nextOffset: number | null;
};
