...
import { ResearchDocumentBlockId, ResearchDocumentId, ResearchDocumentQuoteHash, } from "./types.js";
export { ResearchDocumentBlockId, ResearchDocumentId, ResearchDocumentQuoteHash, } from "./types.js";
...
export class ResearchDocumentRuntime extends Service {
     ...
     */
    search(documentId, query, maxResults) {
     ...
     */
    read(documentId, blockId, before, after) {
        ...
        if (focus === -1) {
            throw new ResearchDocumentError(`block "${blockId}" does not belong to research document "${documentId}"`, 'RESEARCH_DOCUMENT_BLOCK_NOT_FOUND');
        }
        return {
